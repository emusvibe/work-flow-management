        ...
        <Card>
          <CardHeader color="primary" icon>
            ...
            <Button
              ...
              onClick={() => setModal({ modal: true, text: "Create Project" })}
            >
              Create new project
            </Button>
          </CardHeader>
          <Dialog
            ...
            maxWidth={
              openModal.text === "Create Project" || 
              openModal.text === "Edit Project" ? "md" : "xs"}
              ...
              <Formik
                ...
                onSubmit={async (values) => {
                  ...
                  axios
                    ...
                    .then((response) => {
                      if (openModal.text === "Edit Project") {
                        axios
                          .get(
                            `${API_URL}jobs-service/Jobs/GetJobCards?clientId=${user?.data?.clientId}`,
                            config
                ...
                actions={[
                  {
                    ...
                    onClick: (event, rowData) => {
                      setJob(rowData);
                      setModal({ modal: true, text: "Edit Project" });
                    },
                  },
                  {
                    icon: "flip",
