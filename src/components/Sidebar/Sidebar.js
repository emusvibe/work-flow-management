...
import { menuItemsDisplay } from "utils/menuItemsDisplay";
    ...
    return routes.map((prop, key) => {
          ...
          >
            ...
            <Collapse in={this.state[prop.state]} unmountOnExit>
              <List className={classes.list + " " + classes.collapseList}>
                {this.createLinks(
                  prop.views.filter((view) => !view.hiddenFromNav)
                )}
              </List>
            </Collapse>
          </ListItem>
      ...
      return (
        <ListItem
          ...
          style={{display: menuItemsDisplay(prop.name) ? 'none' : ""}}
        >
          <NavLink
    ...
    var brand = (
      <div className={logoClasses}>
        <a href="" className={logoMini}>
          <img src={logo} alt="logo" className={classes.img} style={{width: "200px"}} />
        </a>
